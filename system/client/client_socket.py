...
message = str(image) + '$' + str(position)
...
message_chunk = divide_string(message, 1000000)
print(len(message_chunk))
client_socket.send(("!" + str(len_message) + "!").encode())
...
while True:
    ...
    if message == 'quit':
        ...
        # output2 = SEAL.decryption(output2)
